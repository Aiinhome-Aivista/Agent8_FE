  ...
  const roles = [
    {
      ...
      color: "from-blue-600/20 to-cyan-600/20 hover:border-blue-500/50",
    },
    {
    ...
    },
    {
      ...
      color: "from-amber-600/20 to-orange-600/20 hover:border-amber-500/50",
    },
    {
      ...
      color: "from-emerald-600/20 to-teal-600/20 hover:border-emerald-500/50",
    },
  ];
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans relative overflow-x-hidden selection:bg-blue-600 selection:text-white">
      ...
      <header className="sticky top-0 z-40 w-full border-b border-slate-900 bg-slate-950/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 to-teal-500 flex items-center justify-center font-bold text-white text-lg shadow-lg shadow-blue-500/20">
              I
            </div>
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium text-white rounded-lg group bg-gradient-to-br from-blue-600 to-teal-500 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-800 transition-all cursor-pointer"
            >
      ...
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
          <button
            onClick={() => onNavigateToLogin()}
            className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-lg shadow-blue-600/30 transition-all hover:scale-[1.02] cursor-pointer"
          >
            Access Portal
          </button>
          <a
            href="#roles"
            className="w-full sm:w-auto border border-slate-800 hover:border-slate-700 bg-slate-900/40 hover:bg-slate-900/80 text-slate-300 font-semibold px-8 py-3.5 rounded-xl transition-all hover:scale-[1.02] inline-block"
          >
            ...
            <div className="border-r border-slate-800/50 pr-4 space-y-3 hidden md:block">
              ...
              <div className="space-y-1">
                {[
                  ...
                  <div
                    key={idx}
                    className={`p-2 rounded-lg font-medium transition-colors ${idx === 1 ? "bg-blue-600/20 text-blue-300 border border-blue-500/20" : "hover:bg-slate-800/30"}`}
                  >
                    {it}
                  </div>
                ))}
            ...
            <div className="md:col-span-2 flex flex-col justify-between h-full p-2 bg-slate-950/40 rounded-xl border border-slate-800/30">
              <div className="space-y-3">
                <div className="flex gap-2">
                  <div className="w-6 h-6 rounded-full bg-gradient-to-br from-blue-600 to-teal-500 flex items-center justify-center text-[10px] font-bold text-white">
                    AI
                  </div>
                ...
                <div className="flex gap-2">
                  ...
                  <div className="bg-slate-800/50 p-2.5 rounded-xl rounded-tl-none max-w-[85%] text-slate-300">
                    <span className="inline-block text-[9px] text-blue-400 bg-blue-900/30 px-1.5 py-0.5 rounded-full mb-1">
              ...
              <div className="mt-4 pt-2 border-t border-slate-800/50 flex gap-2">
                <div className="flex-1 bg-slate-900/80 border border-slate-800 rounded-lg px-3 py-1.5 text-slate-500">
                  Ask about coverage, claims, or updates...
                </div>
                <button className="bg-blue-600 text-white px-3 rounded-lg font-bold">
                  Send
                </button>
              </div>
            </div>
      ...
      <section
        id="roles"
        className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-slate-900 relative"
      >
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-slate-400 max-w-2xl mx-auto">
            ...
            role. Click a workspace below to auto-fill the credentials and sign
            in instantly!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {roles.map((r, i) => (
            ...
            >
              <div>
                <div className="w-12 h-12 rounded-xl bg-slate-900 border border-slate-850 flex items-center justify-center text-2xl mb-4 group-hover:scale-110 transition-transform">
                  {r.icon}
                </div>
              ...
              <div className="flex items-center justify-between text-xs font-semibold text-blue-400 mt-2">
                ...
                <span className="text-slate-500 font-mono group-hover:text-slate-400">
                  {r.email}
                </span>
              </div>
            </div>
      ...
      <section
        id="features"
        className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-slate-900"
      >
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div
              key={idx}
              className="p-6 rounded-2xl border border-slate-900 bg-slate-900/30 hover:border-slate-800 transition-all group"
            >
      ...
      <section
        id="stats"
        className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t border-slate-900"
      >
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 bg-slate-900/40 rounded-3xl p-8 border border-slate-900 backdrop-blur-sm text-center">
          {[
            ...
            <div key={i}>
              <div className="text-3xl sm:text-4xl font-extrabold bg-gradient-to-r from-blue-400 to-teal-400 bg-clip-text text-transparent">
                {st.val}
              </div>
              <div className="text-xs text-slate-500 font-semibold uppercase mt-2 tracking-wider">
                {st.label}
              </div>
            </div>
          ))}
        ...
        <div className="bg-gradient-to-br from-slate-900 to-blue-950/40 rounded-3xl border border-slate-850 p-8 sm:p-12 relative overflow-hidden flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-shrink-0 flex items-center justify-center p-6 bg-slate-950/80 border border-slate-800 rounded-2xl w-full md:w-auto">
            <div className="space-y-2 text-xs">
              ...
              <div className="flex items-center gap-2 text-green-400 font-semibold">
                <span className="text-base">🛡️</span> Guardrail Compliance
                Verified
              </div>
              <div className="flex items-center gap-2 text-green-400 font-semibold">
                <span className="text-base">🛡️</span> Real-time Audit Trail
                Enabled
              </div>
            </div>
          </div>
      ...
      <footer className="border-t border-slate-900 bg-slate-950 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6 text-sm text-slate-500">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-600 to-teal-500 flex items-center justify-center font-bold text-white text-sm shadow-md">
              I
            </div>
